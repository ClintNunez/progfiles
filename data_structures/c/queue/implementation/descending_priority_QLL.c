...
int main() {
    ...
    enqueue_Priority_Descending_QLL(priorityQLL, 3, 3);
    print_Priority_QLL(priorityQLL);
    enqueue_Priority_Descending_QLL(priorityQLL, 2, 2);
    print_Priority_QLL(priorityQLL);
    enqueue_Priority_Descending_QLL(priorityQLL, 1, 1);
    print_Priority_QLL(priorityQLL);
    enqueue_Priority_Descending_QLL(priorityQLL, 4, 2);
    print_Priority_QLL(priorityQLL);
    enqueue_Priority_Descending_QLL(priorityQLL, 6, 5);
    print_Priority_QLL(priorityQLL);
